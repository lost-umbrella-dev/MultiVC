...
pub fn t(
    ...
    match (key, lang) {
        ...
        ("action.build", Lang::En) => "Build",
        ("action.build", Lang::Ru) => "Собрать",
        ...
        ("settings.install_mode", Lang::En) => "Install mode",
        ("settings.install_mode", Lang::Ru) => "Режим установки",
        ("settings.only_release", Lang::En) => "Release only",
        ("settings.only_release", Lang::Ru) => "Только релиз",
        ("settings.only_build", Lang::En) => "Build only",
        ("settings.only_build", Lang::Ru) => "Только сборка",
        ("settings.both", Lang::En) => "Both",
        ("settings.both", Lang::Ru) => "Оба",
        ...
        ("col.type", Lang::En) => "Type",
        ("col.type", Lang::Ru) => "Тип",
        ...
        ("tip.redownload", Lang::En) => "Redownload core",
        ("tip.redownload", Lang::Ru) => "Перескачать ядро",
        ...
        ("tip.build", Lang::En) => "Build from source",
        ("tip.build", Lang::Ru) => "Собрать из исходников",
        ("tip.release", Lang::En) => "Download release",
        ("tip.release", Lang::Ru) => "Скачать релиз",
        ("tip.delete_source", Lang::En) => "Delete source",
        ("tip.delete_source", Lang::Ru) => "Удалить исходники",
        ...
        ("status.validating", Lang::En) => "Validating...",
        ("status.validating", Lang::Ru) => "Проверка...",
        ...
        ("toast.save_err", Lang::En) => "Save error",
        ("toast.cores_save_err", Lang::En) => "Cores save error",
        ("toast.instances_save_err", Lang::En) => "Instances save error",
        ("toast.cores_installed", Lang::En) => "Installed cores",
        ("toast.cores_install_err", Lang::En) => "Install errors",
        ("toast.cores_valid", Lang::En) => "Cores: all valid",
        ("toast.cores_issues", Lang::En) => "Cores: issues found",
        ("toast.cores_valid_err", Lang::En) => "Cores validation error",
        ("toast.cores_fetched", Lang::En) => "Available versions",
        ("toast.fetch_err", Lang::En) => "Fetch error",
        ("toast.instances_valid", Lang::En) => "Instances: all valid",
        ("toast.instances_issues", Lang::En) => "Instances: issues found",
        ("toast.instances_valid_err", Lang::En) => "Instances validation error",
        ("toast.core_removed", Lang::En) => "Core removed",
        ("toast.core_not_found", Lang::En) => "Core not found",
        ("toast.instance_removed", Lang::En) => "Instance removed",
        ("toast.instance_not_found", Lang::En) => "Instance not found",
        ("toast.instance_created", Lang::En) => "Instance created",
        ("toast.instance_create_err", Lang::En) => "Instance creation error",
        ("toast.instance_info_err", Lang::En) => "Instance info error",
        ("toast.instance_updated", Lang::En) => "Instance updated",
        ("toast.instance_update_err", Lang::En) => "Instance update error",
        ("toast.instance_launched", Lang::En) => "Launched",
        ("toast.instance_launch_err", Lang::En) => "Launch failed",
        ("toast.instance_stopped", Lang::En) => "Instance stopped",
        ("toast.instance_stopped_code", Lang::En) => "exit code",
        ("toast.instance_stopped_killed", Lang::En) => "killed",
        ("toast.core_found", Lang::En) => "Found",
        ("toast.version_not_found", Lang::En) => "Version not found",
        ("toast.fetch_version_err", Lang::En) => "Fetch version error",
        ("toast.core_in_use", Lang::En) => "Cannot delete: used by instance(s)",
        ("toast.fatal_err", Lang::En) => "Fatal error",
        ("toast.worker_stopped", Lang::En) => "Background worker stopped",
        ("toast.build_complete", Lang::En) => "Build complete",
        ("toast.build_err", Lang::En) => "Build error",
        ("toast.deps_installed", Lang::En) => "Dependencies installed",
        ("toast.deps_err", Lang::En) => "Dependency install error",
        ("toast.source_removed", Lang::En) => "Source removed",
        ...
        ("toast.save_err", Lang::Ru) => "Ошибка сохранения",
        ("toast.cores_save_err", Lang::Ru) => "Ошибка сохранения ядер",
        ("toast.instances_save_err", Lang::Ru) => "Ошибка сохранения инстансов",
        ("toast.cores_installed", Lang::Ru) => "Установлено ядер",
        ("toast.cores_install_err", Lang::Ru) => "Ошибки установки",
        ("toast.cores_valid", Lang::Ru) => "Ядра: всё в порядке",
        ("toast.cores_issues", Lang::Ru) => "Ядра: обнаружены проблемы",
        ("toast.cores_valid_err", Lang::Ru) => "Ошибка проверки ядер",
        ("toast.cores_fetched", Lang::Ru) => "Доступные версии",
        ("toast.fetch_err", Lang::Ru) => "Ошибка загрузки",
        ("toast.instances_valid", Lang::Ru) => "Инстансы: всё в порядке",
        ("toast.instances_issues", Lang::Ru) => "Инстансы: обнаружены проблемы",
        ("toast.instances_valid_err", Lang::Ru) => "Ошибка проверки инстансов",
        ("toast.core_removed", Lang::Ru) => "Ядро удалено",
        ("toast.core_not_found", Lang::Ru) => "Ядро не найдено",
        ("toast.instance_removed", Lang::Ru) => "Инстанс удалён",
        ("toast.instance_not_found", Lang::Ru) => "Инстанс не найден",
        ("toast.instance_created", Lang::Ru) => "Инстанс создан",
        ("toast.instance_create_err", Lang::Ru) => "Ошибка создания инстанса",
        ("toast.instance_info_err", Lang::Ru) => "Ошибка получения информации",
        ("toast.instance_updated", Lang::Ru) => "Инстанс обновлён",
        ("toast.instance_update_err", Lang::Ru) => "Ошибка обновления инстанса",
        ("toast.instance_launched", Lang::Ru) => "Запущен",
        ("toast.instance_launch_err", Lang::Ru) => "Ошибка запуска",
        ("toast.instance_stopped", Lang::Ru) => "Инстанс остановлен",
        ("toast.instance_stopped_code", Lang::Ru) => "код выхода",
        ("toast.instance_stopped_killed", Lang::Ru) => "убит",
        ("toast.core_found", Lang::Ru) => "Найдено",
        ("toast.version_not_found", Lang::Ru) => "Версия не найдена",
        ("toast.fetch_version_err", Lang::Ru) => "Ошибка загрузки версии",
        ("toast.core_in_use", Lang::Ru) => "Нельзя удалить: используется инстансом(ами)",
        ("toast.fatal_err", Lang::Ru) => "Критическая ошибка",
        ("toast.worker_stopped", Lang::Ru) => "Фоновый воркер остановлен",
        ("toast.build_complete", Lang::Ru) => "Сборка завершена",
        ("toast.build_err", Lang::Ru) => "Ошибка сборки",
        ("toast.deps_installed", Lang::Ru) => "Зависимости установлены",
        ("toast.deps_err", Lang::Ru) => "Ошибка установки зависимостей",
        ("toast.source_removed", Lang::Ru) => "Исходники удалены",
        ...
        // ── Build stages ────────────────────────────────────────
        ("build.stage.deps", Lang::En) => "Installing dependencies",
        ("build.stage.deps", Lang::Ru) => "Установка зависимостей",
        ("build.stage.source", Lang::En) => "Downloading source",
        ("build.stage.source", Lang::Ru) => "Скачивание исходников",
        ("build.stage.configure", Lang::En) => "Configuring CMake",
        ("build.stage.configure", Lang::Ru) => "Конфигурация CMake",
        ("build.stage.build", Lang::En) => "Building",
        ("build.stage.build", Lang::Ru) => "Сборка",
        ("build.stage.copy", Lang::En) => "Copying artifacts",
        ("build.stage.copy", Lang::Ru) => "Копирование артефактов",
        ("build.stage.done", Lang::En) => "Done",
        ("build.stage.done", Lang::Ru) => "Готово",
        ("build.stage.failed", Lang::En) => "Failed",
        ("build.stage.failed", Lang::Ru) => "Ошибка",

        // ── Modal dialogs ──────────────────────────────────────
        ("modal.deps_title", Lang::En) => "Missing dependencies",
        ("modal.deps_title", Lang::Ru) => "Отсутствуют зависимости",
        ("modal.deps_message", Lang::En) => "The following dependencies need to be installed:",
        ("modal.deps_message", Lang::Ru) => "Необходимо установить следующие зависимости:",
        ("modal.deps_command", Lang::En) => "Command:",
        ("modal.deps_command", Lang::Ru) => "Команда:",
        ("modal.deps_confirm", Lang::En) => "Install",
        ("modal.deps_confirm", Lang::Ru) => "Установить",

        // ── Badges ─────────────────────────────────────────────
        ("badge.release", Lang::En) => "Release",
        ("badge.release", Lang::Ru) => "Релиз",
        ("badge.build", Lang::En) => "Build",
        ("badge.build", Lang::Ru) => "Сборка",
