...
MultiVC управляет версиями движка [VoxelCore](https://github.com/MihailRis/voxelcore): каждая версия устанавливается один раз, а игровые миры (инстансы) ссылаются на нужную версию по хэшу. Доступно в виде **GUI** (egui) и **CLI** (clap).

## Скриншоты

| Ядра | Инстансы |
|:----:|:--------:|
| ![Вкладка Cores](docs/assets/gui-cores.webp) | ![Вкладка Instances](docs/assets/gui-instances.webp) |
